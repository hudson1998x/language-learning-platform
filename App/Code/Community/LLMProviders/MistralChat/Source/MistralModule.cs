...
public class MistralModule : IModuleLoader
{
    public Task AppStart()
    {
        ...
        {
            registry.AddAutoImport("./App/Code/Community/LLMProviders/MistralChat/Source/web/configuration/model-selector/index.tsx");
            registry.AddAutoImport("./App/Code/Community/LLMProviders/MistralChat/Source/web/help/connecting-mistral/index.tsx");
        });
        ...
        Eventing.Eventing.Of<KestrelHttpEvents>().WebApplication.Concurrent(webApp =>
        {
            ...
            {
                RequestPath = "/media/mistral/help", 
