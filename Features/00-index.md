# LLE — Language Learning Experience

**Learn a language by actually using it.**

Most apps teach you to memorise. LLE helps you *live* the language. Chat with an AI tutor, translate your favourite songs, roleplay real-life situations, and practise with AI characters that feel like real people — all in one place.
...
| Flash Cards | `../Screenshots/flashcards.png` |
| Flash Card Study | `../Screenshots/study-session.png` |
| Create Flash Card | `../Screenshots/create-flashcard-with-pronunciation.png` |
